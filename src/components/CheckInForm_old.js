            ...
            <div className="card-body p-3" style={{ backgroundColor: '#ecf0f1'}}>
              ...
              {!otpSent && (
                <div>
                  ...
                  <div className="mb-3">
                    <label htmlFor="mobile" className="form-label" style={{fontSize: "16px"}}>Mobile Number</label>
                    <input
                      type="text"
                  ...
                  <button type="button" className="btn btn-primary w-100 btnColor" onClick={sendOtp}>
                    Send OTP
                  </button>
                </div>
              )}
              ...
              {isVerified && (
                <form onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className="btn btn-primary w-100 btnColor">Submit</button>
                </form>
              )}
            </div>
          </div>
